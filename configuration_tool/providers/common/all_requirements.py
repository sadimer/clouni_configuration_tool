from configuration_tool.providers.common.requirement import ProviderRequirement

from configuration_tool.common import utils
from configuration_tool.common.tosca_reserved_keys import OCCURRENCES, NODE, NAME, REQUIREMENTS
